...
exports.up = async (db) => {
  ...
  await db.addIndex('mailing_texts', 'idx_mailing_texts_column', ['mailing_column_id', 'deleted_at'])
  await db.addIndex('mailing_texts', 'idx_mailing_texts_contact', ['mailing_contact_id', 'deleted_at'])
