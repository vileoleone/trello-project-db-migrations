...
exports.up = async (db) => {
  await db.createTable('mailing_column_urls', {
  ...
  await db.runSql('ALTER TABLE mailing_column_urls ADD CONSTRAINT pk_mailing_column_urls PRIMARY KEY (mailing_contact_id, mailing_column_id, deleted_at)')
}

exports.down = (db) => (
  db.dropTable('mailing_column_urls')
)
