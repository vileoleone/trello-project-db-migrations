...
exports.up = async (db) => {
  await db.addColumn('call_responses', 'profiler_tree_id', { type: STRING, notNull: false, length: 36 })
  await db.addColumn('call_responses', 'profiler_field_id', { type: BIGINT, notNull: false })
