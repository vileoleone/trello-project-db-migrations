...
exports.up = async (db) => {
  ...
  await db.addIndex('mailing_numbers', 'idx_mailing_numbers_column', ['mailing_column_id', 'deleted_at'])
  await db.addIndex('mailing_numbers', 'idx_mailing_numbers_contact', ['mailing_contact_id', 'deleted_at'])
