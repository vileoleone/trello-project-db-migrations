...
exports.up = async (db) => {
  await db.createTable('mailing_source_columns', {
  ...
  await db.runSql('ALTER TABLE mailing_source_columns ADD CONSTRAINT pk_mailing_source_columns PRIMARY KEY (mailing_source_id, mailing_column_id, deleted_at)')
}

exports.down = (db) => (
  db.dropTable('mailing_source_columns')
)
